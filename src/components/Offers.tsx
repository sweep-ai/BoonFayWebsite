...
export default function Offers() {
  ...
  return (
    <section id="offers" className="bg-background px-4 py-10 sm:py-12 md:py-16">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            <div className="relative">
              ...
              <div className="relative bg-card/80 backdrop-blur-md rounded-xl shadow-xl z-10 p-4 sm:p-6 md:p-8 flex flex-col h-full">
                  ...
                  <div className="mb-4 sm:mb-6">
                    ...
                    <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-muted-foreground">
                      <li className="flex items-start gap-2 sm:gap-3">
                        ...
                        <span>
                          <strong>Fully customized workouts</strong> - Tailored to your fitness level and goals
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Macro-based meal planning</strong> - Personalized nutrition plans
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>24/7 accountability coaching</strong> - Weekly check-ins and unlimited support
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Instructional workout videos</strong> - Learn proper form and technique
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Progress tracking tools</strong> - Monitor your transformation journey
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                ...
                >
                  <span className="hidden sm:inline">Get Started - </span>$250
              ...
              <div className="relative bg-card/80 backdrop-blur-md rounded-xl shadow-xl z-10 p-4 sm:p-6 md:p-8 flex flex-col h-full">
                <div className="flex-1">
                  <div className="text-center mb-4 sm:mb-6">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2">2-Week Trial</h3>
                    <div className="mb-3 sm:mb-4">
                  ...
                  <div className="mb-4 sm:mb-6">
                    ...
                    <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-muted-foreground">
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>2 weeks of personalized workouts</strong> - Get a taste of the program
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Nutrition guidance</strong> - Meal planning basics
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Coaching support</strong> - Weekly check-ins during trial
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Workout videos</strong> - Learn proper form and technique
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Progress tracking</strong> - See your results
                        </span>
                      </li>
                      <li className="flex items-start gap-2 sm:gap-3">
                        <span className="text-white mt-1 flex-shrink-0">✓</span>
                        <span>
                          <strong>Upgrade anytime</strong> - Seamless transition to full program
                        </span>
                      </li>
                    </ul>
                    <div className="mt-3 sm:mt-4 p-2 sm:p-3 bg-white/30 rounded-lg border border-white/40">
                      <p className="text-xs text-gray-800 text-center leading-relaxed">
                        <strong>Note:</strong> One-time payment. You can upgrade to the full subscription after your
                        trial.
                      </p>
                    </div>
                  </div>
